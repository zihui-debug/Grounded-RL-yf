...
if [ "$domain" == "web_grounding" ]; then
    ...
    if [ "$condition" == "vanilla_thinking" ]; then
        ...
        MODEL_PATH="/home/zhaochaoyang/yangfan/project/Qwen2.5-VL-traj/checkpoints/trajvlm/Qwen2.5-VL-7B-Instruct-gqa-multiturn-sft-maxpixel12845056-lr2e-6_1005" 
        SYSTEM_PROMPT="" # replace with the prompt for your dataset
