...
class ActorConfig:
    ...
    mask_negative_advantage: bool = field(default=False, init=False)
    adaptive_lr: bool = field(default=False, init=False)
    min_lr_ratio: float = field(default=0.1, init=False)
