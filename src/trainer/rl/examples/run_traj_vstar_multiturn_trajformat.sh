...
export RAY_ADDRESS="ray://192.168.100.41:10001"
...
if [ "$domain" == "web_grounding" ]; then
    ...
    if [ "$condition" == "vanilla_thinking" ]; then
        ...
        MODEL_PATH="/home/zhaochaoyang/yangfan/project/Qwen2.5-VL-traj/checkpoints/trajvlm/Qwen2.5-VL-7B-Instruct-minio3-multiturn-trajformat-sft-maxpixel12845056-maxlength32768-lr2e-6-ep10_1026" 
        SYSTEM_PROMPT="" # replace with the prompt for your dataset
        MODEL_TAG="vigorl_qwen2_5_vl_7b_traj_minio3_multiturn_trajformat"
        REWARD_FUNCTION=./examples/reward_function/all_reward.py:compute_score
        MULTITURN=true

    fi

    train_file="/home/zhaochaoyang/yangfan/project/Grounded-RL-yf/src/trainer/rl/examples/input_data_vstar_multiturn_trajformat.txt"
    val_file="/home/zhaochaoyang/yangfan/project/Grounded-RL-yf/src/trainer/rl/examples/input_data_val_vstar_multiturn_trajformat.txt"
