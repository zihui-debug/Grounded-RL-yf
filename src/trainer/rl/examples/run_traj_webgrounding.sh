...
if [ "$domain" == "web_grounding" ]; then
    ...
    if [ "$condition" == "vanilla_thinking" ]; then
        ...
        MODEL_TAG="vigorl_qwen2_5_vl_7b_traj_webgrounding"
    ...
    train_file="/home/zhuyousong/yangfan/grounded-rl/src/trainer/rl/examples/input_data_webgrounding.txt"
    val_file="/home/zhuyousong/yangfan/grounded-rl/src/trainer/rl/examples/input_data_val_webgrounding.txt"
