...
if [ "$eval_type" == "vstar" ]; then
    ...
    MODEL="/home/zhaochaoyang/yangfan/project/Qwen2.5-VL-traj/checkpoints/trajvlm/Qwen2.5-VL-7B-Instruct-gqa-multiturn-sft-maxpixel12845056-lr2e-6_1005" # gsarch/ViGoRL-Multiturn-7b-Web-Grounding
    MODEL_TAG="Qwen2.5-VL-7B-Instruct-gqa-multiturn-sft-maxpixel12845056_vstar_multicrop"
...
python -m src.vlmsearch \
    ...
    --check_for_crop \
    --multicrop \
    --save_rollouts_dir "data/eval/traj_multiturn_vstar_test" \
    ${args_to_add}
